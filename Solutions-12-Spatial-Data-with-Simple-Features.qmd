---
title: "Solutions Module 12: Spatial Data with Simple Features"
...
```{r}
# create polygon
pent <- matrix(c(0,0, 10,0, 15,5, 10,10, 0,10, 0,0), ncol = 2, byrow = TRUE)  # create outer ring
tri_hole <- matrix(c(2,2, 2,8, 5,5, 2,2), ncol = 2, byrow = TRUE)  # create hole
my_pts <- list(pent, tri_hole)  # create polygon
my_poly <- st_polygon(my_pts)
plot(my_poly)  # print polygon
```
...
caco <- us_sf[us_sf$NAME == "Colorado" | us_sf$NAME == "California",]
class(caco)
```
